...
<div class="modal fade" id="kredit_form" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Form Kredit</h3>
            </div>
             
            <div class="modal-body form">
                 <form action="<?php echo base_url('home/kredit/'.$status); ?>" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="id_kredit" value="<?php if(isset($edt)){ echo $edt->id_kredit; }?>" disabled>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="date" name="tgl" value="<?php if(isset($edt)){ echo $edt->tgl_kredit; }?>">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
 ...
 <div class="panel panel-primary">
  ...
  foreach ($debetku as $saldo){
    ...
    <div class="col-sm-8 text-left" id="kredit"> 
    <br>
     <button class="btn btn-warning" data-toggle="modal" data-target="#kredit_form"><i class="glyphicon glyphicon-plus"></i> Add Kredit</button><br>
    ...
    <tbody class="list">
      ...
      <!-- echo $bebas->seko database; -->
        ...
        <td class="jml"><?php echo $bebas->jml;?></td>
     	<td><a href="<?php echo base_url('home/hapuskredit/'.$bebas->id_kredit); ?>">delete</a></td>
      </tr>
...
var userList = new List('kredit', options);
